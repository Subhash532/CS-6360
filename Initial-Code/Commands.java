...
public class Commands {
	...
	public static void help() {
		...
		out.println("\tDisplay a list of all tables in Gell-Mann DataBase\n");
		out.println("CREATE TABLE;");
		out.println("\tCreates a New Table file and indexes\n");
		out.println("DROP TABLE;");
		out.println("\tRemove table data (i.e. all records) and its schema.\n");
		out.println("CREATE INDEX;");
		out.println("\tCreates a Index file i.e., associated with Table File.\n");
		...
		out.println("\tDelete one or more records from the table.");
